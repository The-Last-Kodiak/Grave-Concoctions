...
def get_capacity_plan():
    ...
    if total_potions_in_stock >= (pot_cap - p_space) and gold >= 1060 and total_ml_in_stock >= ml_space:
        gold -= 1000
        potion_capacity += 1
        if gold >= 2860:
            gold -= 1000
    ...
    if total_ml_in_stock >= (ml_cap - ml_space) and gold >= 1050 and total_potions_in_stock >= p_space:
        gold -= 1000
        ml_capacity += 1
        if gold >= 2500:
            gold -= 1000
